 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" id="page-wrapper">  
                <h3 align="center">Citizens Feedback</h3>  
                <br />  
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal col-sm-12" action="feedback.php" method="post">
                    ...
                    <div class="form-group"><label>Password</label><input name="password"  value="" class="form-control password" placeholder="use a strong password" data-placement="top" data-trigger="manual" data-content="Must be a valid e-mail address (user@gmail.com)" type="text"></div>
