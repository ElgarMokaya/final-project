...
// {
// 	$query .= 'WHERE project LIKE "%'.$_POST["search"]["value"].'%" ';
...
foreach($result as $row)
{
	...
	// $sub_array[] = '<button type="button" name="delete" id="'.$row["project_id"].'" class="btn btn-danger btn-xs delete">Delete</button>';
	$data[] = $sub_array;
}
$output = array(
